        ...
        <div className="container mx-auto px-4">
          ...
          >
            {mentorshipTracks.map((track, index) => (
              ...
              >
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-br from-primary/20 via-secondary/20 to-accent/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              ...
              >
                <Card className="bg-card/50 backdrop-blur-sm border-border h-full">
                  ...
                  >
                    <CardHeader>
                      <motion.div 
                        className={`bg-gradient-to-br from-primary/10 to-secondary/10 ${programme.color} w-14 h-14 rounded-2xl flex items-center justify-center mb-6`}
                        whileHover={{ rotate: 360, scale: 1.1 }}
                        transition={{ duration: 0.6 }}
                      >
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {whyXskills.map((reason, index) => (
              ...
              >
                <motion.div 
                  className="bg-gradient-to-br from-primary/10 to-secondary/10 text-primary w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6"
                  whileHover={{ rotate: 360, scale: 1.1 }}
                  transition={{ duration: 0.6 }}
                >
